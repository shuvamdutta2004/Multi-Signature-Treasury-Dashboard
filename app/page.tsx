...
const features = [
  {
    ...
    description:
      "Funds can only be moved with approval from N-of-M registered signers. No single point of compromise.",
  ...
  },
  {
    ...
    description:
      "Any signer can create a spend proposal. All proposal data lives transparently on the Soroban smart contract.",
  ...
  },
  {
    ...
    description:
      "Vote to approve or reject proposals. Threshold-based consensus ensures democratic control of treasury assets.",
  ...
  },
  {
    ...
    description:
      "Watch contract events stream in live. Every vote, proposal, and execution is recorded and displayed instantly.",
  ...
  },
  {
    ...
    title: "Non-Custodial",
    description:
      "Built on Soroban. You control your keys — connect with Freighter, xBull, ALBEDO, Lobstr, or Rabet.",
  ...
  },
  {
    ...
    description:
      "Deployed to the Stellar Testnet. Get free XLM from Friendbot and experiment risk-free.",
    ...
    <div className="max-w-5xl mx-auto space-y-16 py-8">
      ...
      <section className="text-center space-y-6">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
          <span className="gradient-text">Multi-Sig Treasury</span>
          <br />
          <span className="text-foreground">Built on Soroban</span>
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          A decentralized multi-signature treasury dashboard. Create spend proposals,
          vote collectively, and execute transfers — all governed by a Soroban smart contract on Stellar.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/treasury"
            id="hero-cta-treasury"
      ...
      <section className="grid grid-cols-3 gap-4">
        {[
          ...
          { label: "Consensus", value: "SCP", sub: "Federated" },
        ].map(({ label, value, sub }) => (
          ...
          {[
            {
              ...
              desc: "Use Freighter or any supported Stellar wallet. You'll be identified as a signer by your public key.",
            },
            {
              step: "02",
              title: "Create Proposal",
              desc: "Propose a treasury spend: specify recipient, amount in XLM, and a description.",
            },
            {
              step: "03",
              title: "Vote & Execute",
              desc: "Signers vote on-chain. Once threshold is reached, any signer can execute the transfer.",
            },
          ].map(({ step, title, desc }) => (
      ...
      <section className="glass-card p-8 text-center space-y-4 glow-border">
        ...
        <h2 className="text-2xl font-bold">Ready to govern your treasury?</h2>
        <p className="text-muted-foreground max-w-md mx-auto">
          Connect a Stellar wallet and start creating proposals on the testnet right now.
        </p>
        <Link
          href="/treasury"
          className="inline-flex items-center gap-2 btn-primary px-6 py-3"
          id="bottom-cta-treasury"
        >
          Launch Dashboard
          <ArrowRight className="w-4 h-4" />
        </Link>
